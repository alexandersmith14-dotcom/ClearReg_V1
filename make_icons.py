...
derived from PRODUCT_NAME below, so it says "C" here and "M" on Mihari's own
copy of this file without any other change needed. A small lime dot at the
letter's upper-right is the one remaining nod to Check Spike's own
